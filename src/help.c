...
static void help_info(void)
{
  fprintf(stdout,
    "Command: --info\n"
    "\n"
    "  Display a short summary of a PHYLIP alignment file.\n"
    "\n"
    "  Currently prints the number of loci (alignments) contained in the\n"
    "  input file. Accepts both uncompressed PHYLIP and pattern-compressed\n"
    "  PHYLIP (P JC69 / P GTR) input.\n"
    "\n"
    "Syntax:\n"
